...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 05-Jul-2018 às 02:00
...
INSERT INTO `tbgrupo` (`id`, `nome`) VALUES
(1, 'Grupo 1'),
(2, 'Grupo 2'),
(3, 'Grupo 3'),
(4, 'Grupo 4'),
...
CREATE TABLE IF NOT EXISTS `tbprojeto` (
  ...
  `urlVideo` varchar(1000) DEFAULT NULL,
  `passosJson` text,
  `custosJson` text,
  `materiaisJson` text,
  `idUsuario` int(11) DEFAULT NULL,
...
INSERT INTO `tbprojeto` (`id`, `nome`, `urlVideo`, `passosJson`, `custosJson`, `materiaisJson`, `idUsuario`) VALUES
(1, 'Projeto de teste', 'https://www.youtube.com/watch?v=GHB86yxT-W8', '{\r\n \"Passo a Passo\": \r\n   {\r\n    \"1º Passo\": \"Separe os materiais\",\r\n    \"2º Passo\": \"Separe os materiais\",\r\n    \"Atenção\": \r\n     {\r\n      \"1º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\",\r\n      \"2º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\"\r\n     }\r\n   }\r\n}', '{\r\n \"Passo a Passo\": \r\n   {\r\n    \"1º Passo\": \"Separe os materiais\",\r\n    \"2º Passo\": \"Separe os materiais\",\r\n    \"Atenção\": \r\n     {\r\n      \"1º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\",\r\n      \"2º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\"\r\n     }\r\n   }\r\n}', '{\r\n \"Passo a Passo\": \r\n   {\r\n    \"1º Passo\": \"Separe os materiais\",\r\n    \"2º Passo\": \"Separe os materiais\",\r\n    \"Atenção\": \r\n     {\r\n      \"1º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\",\r\n      \"2º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\"\r\n     }\r\n   }\r\n}', 1),
(2, 'Projeto de aquaponia', 'https://www.youtube.com/watch?v=ymknJKeFoLY', '{\r\n \"Passo a Passo\": \r\n   {\r\n    \"1º Passo\": \"Separe os materiais\",\r\n    \"2º Passo\": \"Separe os materiais\",\r\n    \"Atenção\": \r\n     {\r\n      \"1º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\",\r\n      \"2º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\"\r\n     }\r\n   }\r\n}', '{\r\n \"Passo a Passo\": \r\n   {\r\n    \"1º Passo\": \"Separe os materiais\",\r\n    \"2º Passo\": \"Separe os materiais\",\r\n    \"Atenção\": \r\n     {\r\n      \"1º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\",\r\n      \"2º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\"\r\n     }\r\n   }\r\n}', '{\r\n \"Passo a Passo\": \r\n   {\r\n    \"1º Passo\": \"Separe os materiais\",\r\n    \"2º Passo\": \"Separe os materiais\",\r\n    \"Atenção\": \r\n     {\r\n      \"1º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\",\r\n      \"2º Passo\": \"Nunca mexa com fogo sem a presença de um adulto\"\r\n     }\r\n   }\r\n}', 1);
...
INSERT INTO `tbtag` (`id`, `nome`) VALUES
(1, 'Madeira'),
(2, 'Alumínio'),
(3, 'Papelão');
